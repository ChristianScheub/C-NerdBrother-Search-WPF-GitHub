...
{
    public partial class BigSyncForm : Form
    {
        public BigSyncForm()
        {
            InitializeComponent();
...
*/
            ...
            if (checkBox_folgeLinks.Checked == true) //Es wird auch nach FolgeLinks gesucht
            {
                ...
                String URL_New = textBox3.Text;
                LogScreen.Show();
                LogScreen.Main2(URL_New);

                URL_New = textBox4.Text;
                LogScreen.Show();
                LogScreen.Main2(URL_New);

                URL_New = textBox5.Text;
                LogScreen.Show();
                LogScreen.Main2(URL_New);

                URL_New = textBox6.Text;
                LogScreen.Show();
                LogScreen.Main2(URL_New);
                ...
                URL_New = textBox7.Text;
                LogScreen.Show();
                LogScreen.Main2(URL_New);

                URL_New = textBox8.Text;
                LogScreen.Show();
                LogScreen.Main2(URL_New);

                URL_New = textBox9.Text;
                LogScreen.Show();
                LogScreen.Main2(URL_New);

                URL_New = textBox10.Text;
                LogScreen.Show();
                LogScreen.Main2(URL_New);

                URL_New = textBox11.Text;
                LogScreen.Show();
                LogScreen.Main2(URL_New);

                URL_New = textBox12.Text;
                LogScreen.Show();
                LogScreen.Main2(URL_New);

                URL_New = textBox13.Text;
                LogScreen.Show();
                LogScreen.Main2(URL_New);

                URL_New = textBox14.Text;
                LogScreen.Show();
                LogScreen.Main2(URL_New);
            }
            textBox1.Text = textBox1.Text + BobMarley;
